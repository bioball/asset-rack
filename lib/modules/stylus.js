...
(function() {
  var Asset, fs, nib, pathutil, stylus, urlRegex, urlRegexGlobal,
  ...
  exports.StylusAsset = (function(_super) {
    ...
    function StylusAsset() {
      return StylusAsset.__super__.constructor.apply(this, arguments);
    }
    ...
    StylusAsset.prototype.create = function(options) {
      ...
      return fs.readFile(this.filename, 'utf8', (function(_this) {

...
(function() {
  var Asset, fs, pathutil, sassy, urlRegex, urlRegexGlobal,
  ...
  exports.SassAsset = (function(_super) {
    ...
    function SassAsset() {
      return SassAsset.__super__.constructor.apply(this, arguments);
    }
    ...
    SassAsset.prototype.create = function(options) {
      ...
      return sassy.compile(this.filename, sassOpts, (function(_this) {

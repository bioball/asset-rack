...
(function() {
  ...
  exports.JavascriptAsset = (function(_super) {
    ...
    function JavascriptAsset() {
      return JavascriptAsset.__super__.constructor.apply(this, arguments);
    }
    ...
    JavascriptAsset.prototype.create = function(options) {
      ...
      return async.eachSeries(this.code, (function(_this) {
